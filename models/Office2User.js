...
const userSchema = new Schema ({
    ...
    role: {
        type: String,
        enum: ['CRM Manager', 'Retention Agent', 'Conversion Agent', 'Retention Manager', 'Conversion Manager', 'guest'],
        default: null,
...
const Office2User = model("Office2_Users", userSchema);


module.exports = {Office2UserSchemas, Office2User};