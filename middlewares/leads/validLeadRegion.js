...
const validLeadRegion = async (req, res, next) => {
    ...
    switch(authBranch){
        case "Main":
            ...
            switch(lead.branch){
                case "Office1":
                    schema = Office1Schemas.office1RegionSchema;
                    break;
                case "Office2":
                    schema = Office2Schemas.office2RegionSchema;
                    break;
                default: 
...
module.exports = validLeadRegion;