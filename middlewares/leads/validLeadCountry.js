...
const validLeadCountry = async (req, res, next) => {
    ...
    switch(authBranch){
        case "Main":
            ...
            switch(lead.branch){
                case "Office1":
                    schema = Office1Schemas.office1CoutrySchema;
                    break;
                case "Office2":
                    schema = Office2Schemas.office2CoutrySchema;
                    break;
                default: 
...
module.exports = validLeadCountry;
